...
public class RoutePlanActivity extends Activity implements
	...
	public void SearchButtonProcess(View v) {
		...
		// }
		// String sx = "34.445711";
		// String sy = "108.766873";

		PlanNode stNode = PlanNode.withLocation(latlng);
		// PlanNode stNode = PlanNode.withLocation(new
		// LatLng(34.445711,108.766873));
		PlanNode enNode = PlanNode.withLocation(new LatLng(30.252412,
				120.989795));
		...
		System.out.println("stNode____:" + stNode);
		System.out.println("enNode____:" + enNode);
	...
	public void changeRouteIcon(View v) {
		...
		if (useDefaultIcon) {
			...
			Toast.makeText(this, "将使用自定义起终点标", Toast.LENGTH_SHORT).show();
