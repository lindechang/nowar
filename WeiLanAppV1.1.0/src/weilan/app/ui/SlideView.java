...
public class SlideView extends LinearLayout {
	...
	private void initView() {
		...
		View.inflate(mContext, R.layout.slide_listview_merge, this);
	...
	public void shrink() {
		if (getScrollX() != 0) {
			...
			// ProgressDialog m_pDialog = new ProgressDialog(MainActivity);
			// MainActivity m_pDialog = new MainActivity();
			// m_pDialog.m_pDialog.hide();
		}
	}
