...
public class CacheUtils {
    ...
    public static File getExternalCacheDir(Context context, String dirName) {
        File dataDir = new File(new File(Environment.getExternalStorageDirectory(), "Nowar"), "data");
        File appCacheDir2 = new File(new File(dataDir, context.getPackageName()), "img");
