...
public class BtDB {
	...
	public BtDB Open() throws SQLException {
	 ...
	 * @return
	 */
	public BtDevice getSW(int position) {
	 ...
	 * @return
	 */
	public ArrayList<BtDevice> fetchAll() {
